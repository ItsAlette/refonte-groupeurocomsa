...
<div className="max-w-[85rem] px-4 pt-8 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1">
            <div className="lg:mb-0 mb-10">
                <div className="group w-full h-full">
                    <div className="relative h-full">
                        <img src="https://images.unsplash.com/photo-1554469384-e58fac16e23a?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YnVpbGRpbmd8ZW58MHx8MHx8fDA%3D" alt="ContactUs tailwind section" className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-blue-900 object-cover"/>
                        ...
                        <div className="absolute bottom-0 w-full lg:p-11 p-5">
                            <div className="bg-white rounded-lg p-6 block">
                                <a href="javascript:;" className="flex items-center mb-6">
                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" stroke="#233876" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 className="text-gray-600 text-base font-normal leading-6 ml-5">+248 250 8571</h5>
                                </a>
                                 <a href="javascript:;" className="flex items-center mb-6">
                                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#233876" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="12" cy="12" r="9" strokeWidth="2" />
                                        <path d="M12 7v5l3 3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                    <h5 className="text-gray-600 text-base font-normal leading-6 ml-5">Monday to Friday from 8:00 am to 16:30</h5>
                                </a>
                                <a href="javascript:;" className="flex items-center mb-6">
                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" stroke="#233876" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 className="text-gray-600 text-base font-normal leading-6 ml-5">contact@groupeurocomsa.com</h5>
                                </a>
                                <a href="javascript:;" className="flex items-center">
                                    ...
                                    <h5 className="text-gray-600 text-base font-normal leading-6 ml-5">Global Gateway 8, Rue de la Perle, Providence, Mahe, Seychelles</h5>
                                </a>
            ...
            <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                <h2 className="text-blue-900 font-manrope text-4xl font-semibold leading-10 mb-11">Fill in the form</h2>
                ...
                <div className="mb-10">
                    ...
                    <div className="flex">
                        <label className="flex items-center mr-11 cursor-pointer text-gray-500 text-base font-normal leading-6">
                ...
                <textarea className="w-full min-h-[160px] text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none p-4 mb-10" placeholder="Message"></textarea>
