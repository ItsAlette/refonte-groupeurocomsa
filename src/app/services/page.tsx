          ...
          <div className="mx-auto max-w-7xl px-4  sm:px-6 lg:px-8">
           ...
           <div className="space-y-4">
            ...
            <div className="flex gap-6 overflow-x-auto pb-10 snap-x snap-mandatory [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
              ...
              <div className="w-[50%] flex-shrink-0 snap-center group">
                <div className="relative w-[50%] overflow-hidden rounded-[3rem] shadow-2xl border-4 border-white transition-all duration-500 hover:shadow-[#233876]/20">
